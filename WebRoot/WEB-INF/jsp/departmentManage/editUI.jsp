  ...
  <body >
  	<div class="container" ng-controller="formCtrl">
  		<header ng-include="topUrl" style="margin-bottom:10%"></header>
	   		<form action="${pageContext.request.contextPath}/departmentManage/edit"
			 method="post" class="form-horizontal" novalidate name="form">
				
   			<input type="hidden" name="did" ng-value="department.id">
			<legend>部门信息</legend>
			
			<div class="control-group">
				<label class="control-label">部门名称:</label>
				<div class="controls">
					<input type="text" name="name"  required  ng-trim="true" ng-value="department.name" ng-model="department.name">
